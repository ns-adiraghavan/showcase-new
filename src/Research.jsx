...
import { NS, ACCENT, driveFile, RESEARCH_DATA, SECTOR_ORDER, SECTORS, STUDY_TYPES, GEO_REGIONS } from "./researchData";
...
function ExpertiseSection({ onOpenCase, onPanelChange }) {
  ...
  const EXPERTISE_CARDS = [
    { id:"B2B",  label:"B2B Research",            tag:"Decision-maker intelligence", accent:NS.blue,
      ...
      featured:["Enabling Growth Strategies for Cross-border Digital Payment Platforms in China","Engagement Perception for an International Bank","GTM Strategy for a Cloud-Based Cybersecurity Startup"] },
