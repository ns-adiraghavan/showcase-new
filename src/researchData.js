...
export const RESEARCH_DATA = [
  ...
  { title:"Battle Card Development for Enterprise Automation Platforms", desc:"Competitive benchmarking and account intelligence engagement building sales battle cards for enterprise automation platforms — informed by qualitative interviews with CIOs, CTOs, digital transformation leaders, and IT infrastructure heads.", industry:"tech", studyType:"Competitive Benchmarking", geo:["Global"], primaryType:"B2B", ...driveFile("1UNVrC8hJD_f8wb_QziUzpYbWoq-_1_ft") },
  { title:"Strengthening Competitive Positioning Through Battle Card Benchmarking", desc:"Competitive benchmarking and account intelligence study using battle card frameworks to sharpen competitive positioning across enterprise technology accounts.", industry:"tech", studyType:"Competitive Benchmarking", geo:["Global"], primaryType:null, ...driveFile("1TVKWzSgwuaCf6UvMcOgh_YyID-6Cwy48") },
